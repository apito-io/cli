...
func createPlugin() {
    ...
    idx, _, err := sel.Run(); if err != nil { return }
    repo := "git@github.com:apito-io/apito-hello-world-go-plugin.git"
    if idx == 1 { repo = "git@github.com:apito-io/apito-hello-world-js-plugin.git" }
    if idx == 2 { repo = "git@github.com:apito-io/apito-hello-world-python-plugin.git" }
